...
Ì†ΩÌ≥ù‚úí Gift
Ì†ΩÌ≥ù‚úí Mid @
Ì†ΩÌ≥ù‚úí Cn: Display Name
Ì†ΩÌ≥ù‚úí Cc: Clock Name
Ì†ΩÌ≥ù‚úí Mc
Ì†ΩÌ≥ù‚úí Mc:
Ì†ΩÌ≥ù‚úí Tl: text
Ì†ΩÌ≥ù‚úí Auto join: on/off
Ì†ΩÌ≥ù‚úí Auto add: on/off
Ì†ΩÌ≥ù‚úí Auto leave: on/off
Ì†ΩÌ≥ù‚úí Clock: on/off
Ì†ΩÌ≥ù‚úí Share on
Ì†ΩÌ≥ù‚úí Add message: text
Ì†ΩÌ≥ù‚úí Message:
Ì†ΩÌ≥ù‚úí Add comment: text
Ì†ΩÌ≥ù‚úí Comment: 
Ì†ΩÌ≥ù‚úí Cbroadcast text
Ì†ΩÌ≥ù‚úí Gbroadcast text
Ì†ΩÌ≥ù‚úí Reject
...
Ì†ΩÌ≥ù‚úí Creator
Ì†ΩÌ≥ù‚úí Gn: text
Ì†ΩÌ≥ù‚úí Invite: mid
Ì†ΩÌ≥ù‚úí mybot
Ì†ΩÌ≥ù‚úí Allgift 
Ì†ΩÌ≥ù‚úí All mid
Ì†ΩÌ≥ù‚úí Cancel
Ì†ΩÌ≥ù‚úí Link on/off
Ì†ΩÌ≥ù‚úí ginfo
Ì†ΩÌ≥ù‚úí Gurl
Ì†ΩÌ≥ù‚úí Glist
Ì†ΩÌ≥ù‚úí Say
Ì†ΩÌ≥ù‚úí Set
Ì†ΩÌ≥ù‚úí Gcancel: number
Ì†ΩÌ≥ù‚úí Masuk / Join
Ì†ΩÌ≥ù‚úí Soldier
Ì†ΩÌ≥ù‚úí Psd out
Ì†ΩÌ≥ù‚úí Pulang
Ì†ΩÌ≥ù‚úí Ban @ target
Ì†ΩÌ≥ù‚úí Uban @ target
Ì†ΩÌ≥ù‚úí Ban -> send contact
Ì†ΩÌ≥ù‚úí Unban -> send contact
Ì†ΩÌ≥ù‚úí Comment bl/wl
Ì†ΩÌ≥ù‚úí Banlist
Ì†ΩÌ≥ù‚úí Cekban
Ì†ΩÌ≥ù‚úí Clear ban
Ì†ΩÌ≥ù‚úí Kill
Ì†ΩÌ≥ù‚úí Kill ban
Ì†ΩÌ≥ù‚úí Speed
Ì†ΩÌ≥ù‚úí Mentionall
Ì†ΩÌ≥ù‚úí Nk @ target
Ì†ΩÌ≥ù‚úí Mk: @ target
Ì†ΩÌ≥ù‚úí Keluar @ target
Ì†ΩÌ≥ù‚úí Cleanse
...
Ì†ΩÌ≥ù‚úí Y1-Y2 say
Ì†ΩÌ≥ù‚úí Y1-Y2 tag
Ì†ΩÌ≥ù‚úí Y1-Y2 invite:
Ì†ΩÌ≥ù‚úí Y1-Y3 mid
Ì†ΩÌ≥ù‚úí Y1-Y2 gurl
Ì†ΩÌ≥ù‚úí Y1-Y5 gift
Ì†ΩÌ≥ù‚úí Y1-Y10 rename:
Ì†ΩÌ≥ù‚úí Y1-Y10 rgroup
Ì†ΩÌ≥ù‚úí Y1-Y5 join
Ì†ΩÌ≥ù‚úí Y1-Y5 bye
Ì†ΩÌ≥ù‚úí Sticker-Sticker10
Ì†ΩÌ≥ù‚úí Y1-Y2 link on/off

>=========COMMAND PROTECT----->

Ì†ΩÌ≥ù‚úí Qr on/off
Ì†ΩÌ≥ù‚úí Backup on/off
Ì†ΩÌ≥ù‚úí Protect On/off


[‚ò∏] Ì†ΩÌ≥ù‚úí Creator By: nZets Ì†ΩÌ≥ù‚úí‚Ä¢‚îÖ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ """
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                L1 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L2 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L3 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L4 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L5 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L6 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L7 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L8 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L9 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                L10 = "‚ò´„Äé Groups List „Äè‚ò´\n"
                for i in gs1:
                    L += "[‚≠ê] %s \n" % (cl.getGroup(i).name + " | [ " + str(len (cl.getGroup(i).members)) + " ]")
                for i in gs2:
                    L += "[‚≠ê] %s \n" % (ki.getGroup(i).name + " | [ " + str(len (ki.getGroup(i).members)) + " ]")
			...
			kc.sendText(msg.to,cmid)
                ...
                ki.sendText(msg.to,"Selamat datang di Family Room ÙÄúÅÙÄÖîHar HarÙèøø")
                kk.sendText(msg.to,"Jangan nakal oklek ÙÄ®ÅÙÄÑªdouble thumbs upÙèøø")
            #elif "Respon" in msg.text:
                #r1 = ki.getProfile()
                #r2 = kk.getProfile()
                #ki.sendText(msg.to, "r1.displayName +  ÙÄúÅÙÄÖîHar HarÙèøø")
                #kk.sendText(msg.to, "r2.displayName +  ÙÄúÅÙÄÖîHar HarÙèøø")
...
#======================================
                ...
                md = "[‚ò∏]Ì†ΩÌµâ SETTING ONLY Ì†ΩÌµâ[‚ò∏]\n"
                
                
                if wait["contact"] == True: md+="Ì†ΩÌµâContact : on\n"
                else: md+="Ì†ΩÌµâContact : off\n"
                if wait["autoJoin"] == True: md+="Ì†ΩÌµâAuto join : on\n"
                else: md +="Ì†ΩÌµâAuto join : off\n"
                if wait["autoCancel"]["on"] == True:md+="Ì†ΩÌµâGroup cancel :" + str(wait["autoCancel"]["members"]) + "\n"
                else: md+= "Ì†ΩÌµâGroup cancel : off\n"
                if wait["leaveRoom"] == True: md+="Ì†ΩÌµâAuto leave : on\n"
                else: md+="Ì†ΩÌµâAuto leave : off\n"
                if wait["timeline"] == True: md+="Ì†ΩÌµâShare : on\n"
                else:md+="Ì†ΩÌµâShare : off\n"
                if wait["clock"] == True: md+="Ì†ΩÌµâClock Name : on\n"
                else:md+="Ì†ΩÌµâClock Name : off\n"
                if wait["autoAdd"] == True: md+="Ì†ΩÌµâAuto add : on\n"
                else:md+="Ì†ΩÌµâAuto add : off\n"
                if wait["commentOn"] == True: md+="Ì†ΩÌµâComment : on\n"
                else:md+="Ì†ΩÌµâComment : off\n"
                if wait["Backup"] == True: md+="Ì†ΩÌµâBackup : on\n"
                else:md+="Ì†ΩÌµâBackup : off\n"
                if wait["qr"] == True: md+="Ì†ΩÌµâProtect QR : on\n"
                else:md+="Ì†ΩÌµâProtect QR : off\n"
                if wait["protectionOn"] == True: md+="Ì†ΩÌµâProtection : on\n\n"+ datetime.today().strftime('%H:%M:%S')
                else:md+="Ì†ΩÌµâProtection : off\n\n"+ datetime.today().strftime('%H:%M:%S')
...
#========================================
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n [‚ò∏]‚û¶Powered By: ZETSU„ÄÖ‚Ä¢‚îÖ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#==========================================
                ...
                if msg.toType == 2:
                    ...
                    kicker.sendText(msg.to,"ÙÇÄÅÙÄÑÉexplosionÙèøø Just some casual cleansing ÙÇÄÅÙÄÑÉexplosionÙèøø")
...
#========================================
                ...
                cl.sendText(msg.to, "%ssecondsÙèøø" % (elapsed_time))
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by : ZETSU „ÄÖ‚Ä¢‚îÖ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ")
            ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by: ZETSU „ÄÖ‚Ä¢‚îÖ‚îÄ‚îÄ‚îÄ‚îÄ‚îÄ")
            print "Like"
          except:
            pass
        else:
