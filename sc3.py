...
from DAECHI.lib.curve.ttypes import *
from datetime import datetime
import time,datetime,random,sys,re,os,json,subprocess,codecs,threading,glob

cl = DAECHI.LINE()
cl.login(token="EmjBoxcicegTCF7beHa0.eyqS4lwjkLcs9GG3+aTgya.C2/G9c+DhEO0Q2l743QNw8/qAUdip5pZZvS/PfDRzCE=")
cl.loginResult()

ki = DAECHI.LINE()
ki.login(token="EmPUqF1h3C3vNu3dYXxa.bOba/r/llc+NXMWep33UQG.D6oTWtk6QIKuJu7+8a24hCUwo9onw/2rIE+QCZo+hKg=")
ki.loginResult()

ki2 = DAECHI.LINE()
ki2.login(token="EmEweY1kRBfIetg0pyab.L80wsUYoU+OAt1ZsSsVKkW.2MMatQxGnWaL6kzDT4ObzGcPUReL1QuaDt45UZr86ak=")
ki2.loginResult()

ki3 = DAECHI.LINE()
ki3.login(token="Emsb3PwqQUNInp0re5tc.1Wb2wayU9dXOMMHdDg+cla./Dpolu5L5VyBe0HO3xiH3sY2a/Rc136ZNcS8mBJgYuE=")
ki3.loginResult()

ki4 = DAECHI.LINE()
ki4.login(token="Emxt582i20DgRInhqJrf.xJI4CSrG9LqsZMY0FfvkRW.SvLxKPIffK8MmCS5S+6zzsuV3HstCzVKhLWWKqgBqj0=")
ki4.loginResult()

ki5 = DAECHI.LINE()
ki5.login(token="EmfhYBeiKNHSDQ6tLKAa.9cs63I3u+igLf6ZfuNhqMG.RzOQKPsiX/a3eVLjHUzPlU94fT9IX0yNquEtdd9LAa4=")
ki5.loginResult()

ki6 = DAECHI.LINE()
ki6.login(token="Em9v3da5JW4cm8H18xO8.ltMGUlE3gvsYjaeDzo06Ma.Zfgm8oPVCbKnoPv1qW85otn8BYG8F01dZTIh7T8rXyI=")
ki6.loginResult()

ki7 = DAECHI.LINE()
ki7.login(token="Em91aZxl4YvCoIg1SFPf.oupMBN26QKtfoT7amh77hW.U+AaaTuUUBwb33hyZOVtZprjwkgvrVMMiDh9KXXy/H4=")
ki7.loginResult()

ki8 = DAECHI.LINE()
ki8.login(token="EmhL4t17tkkpW4HsWDl4.wntFTzFxSNpnKdexx4wjTa.K9K4Oi06CmT4+ZN56KTwp5P0Wbwzw/AaXf0QwXhxXvA=")
ki8.loginResult()

ki9 = DAECHI.LINE()
ki9.login(token="EmlAY8LZYZO0fayH2sIa.UshH2l1imZ66pL0N/cOCYG.k+actvfO9IZBMDsEuN2R2fsTCMsSzX5oVK2eOTzaTfE=")
ki9.loginResult()

ki10 = DAECHI.LINE()
ki10.login(token="Em2llNFUXcCY3Z98D1z7.x8kZkg59IrStQyrGjVisDW.LAk42I+gv9bEswduWvYseMWmCZ44NTV9UjpCQ7uT9Q8=")
ki10.loginResult()
...
Bots=["u11842ce0b5892a5092f60837fc0b4660","u068040f91f8b2c2fe7c66c043f7deeaa","u97cd164aec8ebbfa1a4f5cd2b12be42b","ud7007658062ef43c689a6843746fc22c","u5e38b872c460f65412ce6cb47c554aaf","uf424bade2dd4fc81a517acc55271d09a","u2d39a0b8b7b71954b224011d64ed3a98","u3943e66e7dbaaa44c53adec0307efb1f","u58d4dfb597d7b273cd9031175f8589b4","ub921e1d8bd48333eba3e5d27f82a1cca","u5fc2b3286e7d891b13a9846026f21277"]
admin = "u11842ce0b5892a5092f60837fc0b4660"
admsa = "u11842ce0b5892a5092f60837fc0b4660"
...
instagram.com/daechi_

(っ◔◡◔)っ """,
    "lang":"JP",
    "comment":"Auto Like by instagram.com/daechi_",
    "commentOn":True,
    "commentBlack":{},
    "likeOn":True,
    "wblack":False,
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif msg.text == 'Daechi':
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
            elif msg.text == 'Kanachi':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki2mid}
                ki2.sendMessage(msg)
            elif msg.text == 'Tatsumi':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki3mid}
                ki3.sendMessage(msg)
            elif msg.text == 'Gugenka':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki4mid}
                ki4.sendMessage(msg)
            elif msg.text == 'Chiko':
...
#--------------------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Daechi Bot Sudah Keluar Di semua grup")
                else:
